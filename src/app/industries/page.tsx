...
export default function IndustriesPage() {
  ...
  return (
    <BlurredBackgroundSection 
      backgroundImageUrl="https://songshunsteel.com/wp-content/uploads/2023/10/steel-manufacturers-Fabricators.webp"
      overlayOpacity={0.7}
      blurAmount="blur-sm"
    >
      <div className="pt-36 pb-24 md:pb-32 min-h-screen bg-transparent font-sans selection:bg-[#B38B59] selection:text-white">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <motion.div 
            ...
            className="mb-16 md:mb-24 bg-white/5 backdrop-blur-md border border-[#B38B59]/40 rounded-xl p-6 md:p-10 lg:p-12 relative overflow-hidden shadow-2xl"
          >
