...
export default function AboutPage() {
  ...
  return (
    <BlurredBackgroundSection
      backgroundImageUrl="/assets/images/bg-about.jpg"
      overlayOpacity={0.7}
      blurAmount="blur-sm"
      priority
    >
      <div className="bg-transparent min-h-screen font-sans selection:bg-[#B38B59] selection:text-white pt-28 pb-12 md:pt-36 md:pb-24">
