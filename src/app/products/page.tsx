    ...
    <div className="pt-28 pb-12 md:pt-36 md:pb-24 min-h-screen bg-transparent font-sans selection:bg-[#B38B59] selection:text-white">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-16">
          {[
            { id: "round-bars", title: "Round Bright Bars", image: "/assets/images/prod-round.jpg", features: ["High dimensional accuracy", "Superior surface finish", "Perfect straightness & concentricity", "Excellent machinability"], applications: ["Automotive shafts & axles", "Precision gears", "Machined components", "High-stress fasteners"] },
            { id: "square-bars", title: "Square Bright Bars", image: "/assets/images/prod-square.png", features: ["Precise right-angle geometry", "Tight tolerance control", "Consistent cross-section"], applications: ["Structural framework profiles", "General engineering dies", "Specialized tooling", "Heavy machinery parts"] },
            { id: "hexagon-bars", title: "Hexagon Bright Bars", image: "/assets/images/prod-hex.jpg", features: ["Uniform six-sided geometry", "Clean surface finish", "Excellent concentricity"], applications: ["Premium fasteners & heavy nuts", "Hydraulic fittings & valves", "Automotive structural components", "Precision machinery parts"] },
            { id: "flat-bars", title: "Flat Bright Bars", image: "/assets/images/prod-flat.jpg", features: ["Superior precision & sharp edges", "Consistent profile", "Highly machinable"], applications: ["Machine parts", "Fabrication", "Engineering structures", "Special Purpose Machines (SPM)"] }
          ].map((product, i) => (
            <motion.div
              key={product.id}
              id={product.id}
        ...
        >
          <div className="relative w-full h-56 md:h-80 bg-neutral-900 overflow-hidden">
            <NextImage
              src="/assets/images/prod-small.jpg"
